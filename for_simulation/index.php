...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    ...
    <a class="navbar-brand" href="index.php" id="nm">
        <img src="navicon.svg" width="50" height="50" class="d-inline-block align-top" alt="" loading="lazy">
        GRIP BANK
    </a>
  ...
  <!-- ======= Intro Section ======= -->
  <div id="home" class="intro route bg-image" style="background-image: url(money.jpg)">
        ...
        <div class="container text-center text-md-left mt-5 "  >
            ...
            <div class="row mt-3 text-white">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mb-4">
                    ...
                    <!-- Content -->
                    <h6 class="text-uppercase font-weight-bold text-white">GRIP Bank</h6>
                    <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto">
                    <p>Please do not believe any entity using GRIP Bank logos & branding to request the public for
                        money
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    ...
                    <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                    <p>
                        <i class="fas fa-home mr-3"></i>T nagar, chennai ,India</p>
                    <p>
